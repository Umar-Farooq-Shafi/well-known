<div class="mt-40">
    <div
        ...
        <div class="font-bold text-xl">Privacy Policy</div>
    ...
    <div class="container mx-auto p-4">
        <article class="bg-white rounded-lg shadow-lg p-6 prose max-w-fit flex flex-col lg:prose-lg">
            <p>
                ...
                Identifiable Information’ (PII) is being used online. PII, is information that can be used on its own or
            ...
            <p>
                ...
                ordering or registering on our site, as appropriate, you may be asked to enter your name, email address,
                mailing address, phone number, credit card information or other details to help you with your
                experience.
            </p>

            <p>
                When do we collect information? We collect information from you when you register on our site, place an
                order, subscribe to a newsletter, fill out a form or enter information on our site.
            </p>

            <p>
                How do we use your information? We may use the information we collect from you when you register, make a
                purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website,
            ...
            <p>
                Online Account Registration: To make online shopping faster and easier, you may register on the Aafno
                Ticket website. As a registered customer, you only have to enter your shipping addresses and billing
                information once; they will be securely stored with us for your future use. Using your name and a
                password of your choice, you may access your account online at any time to add, delete, or change
                information.
            </p>

            <p>
                If you are using a public computer, we strongly encourage you to LOG OUT at the conclusion of your
                session. Your information will still be stored with us but it will not be accessible to anyone else from
                that computer.
            </p>

            <p>
                How do we protect your information? Our website is scanned on a regular basis for security holes and
                known vulnerabilities in order to make your visit to our site as safe as possible. We use regular
                Malware Scanning.
            </p>
            ...
            <p>
                If users disable cookies in their browser: If you turn cookies off, Some of the features that make your
                site experience more efficient may not function properly.Some of the features that make your site
                experience more efficient and may not function properly.
            </p>

            <p>
                Third-party disclosure: We do not sell, trade, or otherwise transfer to outside parties your Personally
            ...
            <p>
                Third-party links: Occasionally, at our discretion, we may include or offer third-party products or
            ...
            <p>
                Google: Google’s advertising requirements can be summed up by Google’s Advertising Principles. They are
                put in place to provide a positive experience for users.
            </p>

            <b>https://support.google.com/adwordspolicy/answer/1316548?hl=en</b>
            ...
            <p>
                Opting out: Users can set preferences for how Google advertises to you using the Google Ad Settings
                page. Alternatively, you can opt out by visiting the Network Advertising Initiative Opt Out page or by
